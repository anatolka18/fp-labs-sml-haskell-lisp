...
val test2_ifEq =
  evalExp (ifEq (ADD (INT 1, INT 3), INT 4, ADD (INT 10, INT 1), INT 100))
    = INT 11
val test3_ifEq =
  evalExp (ifEq (ADD (INT 2, INT 3), INT 4, ADD (INT 10, INT 1), INT 100))
    = INT 100
(******************************************************************************)
...
val test5_convertListToMUPL = 
  convertListToMUPL [INT 1, INT 2, INT 3, INT 4, INT 5] =
    PAIR (INT 1, PAIR (INT 2, PAIR (INT 3, PAIR (INT 4, PAIR (INT 5, NULL)))))
(******************************************************************************)
...
val test4_convertListFromMUPL = convertListFromMUPL 
(PAIR (INT 1, PAIR (INT 2, PAIR (INT 3, PAIR (INT 4, PAIR (INT 5, NULL)))))) =
...
val test2_mMapAddN = 
  evalUnderEnv 
    ( CALL ( mMapAddN (VAR "x")
           , PAIR (INT 1, PAIR (INT 2, PAIR (INT 3, NULL))) ) ) [("x", INT 5)]
  = PAIR (INT 6, PAIR (INT 7, PAIR (INT 8, NULL)))
val test3_mMapAddN =
  evalUnderEnv 
    ( CALL ( mMapAddN (ADD (VAR "x", VAR "y"))
           , PAIR (INT 1, PAIR (INT 2, PAIR (INT 3, NULL))) ) ) 
    [("x", INT 5), ("y", INT 6)]
  = PAIR (INT 12, PAIR (INT 13, PAIR (INT 14, NULL)))
val test4_mMapAddN = evalUnderEnv
( CALL ( mMapAddN (VAR "x")
, PAIR (INT 1, PAIR (INT 1, PAIR (INT 1, NULL))) ) ) [("x", INT 15)]
  = PAIR (INT 16,PAIR (INT 16,PAIR (INT 16,NULL)))
(******************************************************************************)
...
val test3_delDuplicates = 
  evalExp 
    ( CALL 
        ( delDuplicates
        , PAIR (INT 1, (PAIR (INT 2, PAIR (INT 2, NULL)))) ) ) 
  = PAIR (INT 1, PAIR (INT 2, NULL))
