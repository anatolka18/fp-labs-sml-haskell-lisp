 ...
 * максимальное возможное количество элементов, не превышающее maxCap. *)
...
signature DESK = sig
  ...
  val make : player list * card list * card list * state * direction * move list 
             -> desk
  ...
  (* Функция добавляет очередной ход к "памяти" хода игры *)
